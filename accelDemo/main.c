...
#include "App/spi.h"
#include "App/accel.h"
#include "App/accel-pin-assign.h"
...
void main(void) {
    ...
    WISP_init();
    BITSET(PAccelPWRDIR, PIN_AccelPWR);
    BITCLR(PAccelPWROUT , PIN_AccelPWR);
    ...
    BITSET(PAccelPWROUT , PIN_AccelPWR);
...
//  __delay_cycles(50);
    ...
    wispData.epcBuf[0] = 0x0C; // Tag type: Accelerometer
    ...
    // Wait here until the device status is correct
